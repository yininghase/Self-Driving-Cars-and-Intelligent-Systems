...
class ModelPredictiveControl:
    def __init__(self, options):
        ...
        # self.smoothness_cost = options["smoothness_cost"]
    ...
    def cost_function(self, u, *args):
        ...
        # u_reshaped = u.reshape(self.horizon, self.num_vehicle, 2)
        # if self.smoothness_cost:
        #     cost += np.mean(np.diff(u_reshaped, axis=0)) * self.smoothness_cost
