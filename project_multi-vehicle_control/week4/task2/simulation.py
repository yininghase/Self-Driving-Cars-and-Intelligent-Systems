...
def sim_run(options, simulation_options, MPC, save=False, name=None, show=True, collect_training_data=False, model=None, show_optimization=True):
    ...
    for i in range(1, sim_total+1):
        ...
        # Model prediction
            ...
            u_model = u_model[0].detach().cpu().numpy()
